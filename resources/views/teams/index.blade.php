        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('teams.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-md">Tambah Anggota</a>
                    ...
                    <table class="w-full mt-4 border-collapse border border-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border p-2">{{ $team->role }}</td>
                                <td class="border p-2">
                                    @if($team->photo)
                                        <img src="{{ asset('storage/' . $team->photo) }}" width="80">
                                    @endif
                                </td>
                                <td class="border p-2">
                                    <a href="{{ route('teams.edit', $team->id) }}" class="px-3 py-1 text-black font-bold rounded-md">Edit</a>
