    ...
    <div class="max-w-screen mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- product_logs --}}
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('product_logs.index')" :active="request()->routeIs('product_logs.index')">
                        {{ __('Riwayat Stok') }}
                    </x-nav-link>
                </div>
                ...
                {{-- social_medias --}}
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('social_medias.index')" :active="request()->routeIs('social_medias.index')">
                        {{ __('Social Medias') }}
                    </x-nav-link>
                </div>
